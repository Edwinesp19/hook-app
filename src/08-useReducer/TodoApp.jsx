...
export default function TodoApp() {
    ...
    <>
     ...
     <section className="relative bg-center w-screen flex fle items-center justify-center gap-3 h-full lg:h-screen">
       <img className=" absolute w-full h-full object-cover" src={backgroundImage} alt="wallpaper" />
     <div className="grid grid-cols-1 lg:grid-cols-[1fr,1fr] h-screen md:h-full md:p-4 md:pb-6 w-full gap-4 max-w-[1300px]">
       <TodoClock/>
            <div className="animate-fade-left animate-delay-100 animate-once animate-ease-in-out animate-alternate h-screen md:h-[95vh] w-full grid grid-rows-[100px,auto,50px] md:grid-rows-[120px,auto,50px] gap-2 p-2 md:p-6 md:border-[1px] md:border-white/20 bg-black/30 backdrop-blur-lg md:rounded-3xl">
