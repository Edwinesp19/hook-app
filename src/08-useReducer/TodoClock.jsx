...
export const TodoClock = () => {
  ...
  return (
    <div className="animate-once animate-ease-in-out animate-normal flex flex-col items-end justify-start h-full  gap-6 ">

    <div className="animate-fade-up animate-delay-75 animate-once animate-ease-in-out animate-normal drop-shadow-md flex gap-2 py-8 items-center justify-start w-full ">
...
<h3 className="animate-fade-up animate-delay-100 animate-once animate-ease-in-out animate-normal text-[130px]  font-bold text-white drop-shadow-xl">
  {time.slice(0,5)}<span className="font-bold text-2xl">{time.slice(5,10)}</span>
</h3>


<h3 className="animate-fade-up  animate-delay-200 animate-once animate-ease-in-out animate-normal capitalize text-2xl font-bold text-white drop-shadow-xl">
  { date }
</h3>
