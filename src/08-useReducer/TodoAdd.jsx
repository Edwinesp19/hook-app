  ...
  return (
    <form onSubmit={onFormsubmit}>
        ...
        <div className="animate-fade-up animate-once animate-ease-in-out animate-delay-300  w-full gap-2 relative flex items-center justify-between rounded-full p-1.5 h-[50px] bg-white/5  text-white border-[1px] border-white/20">
            ...
            className="placeholder:text-white/60 group w-full min-w-[300px] pl-4 pr-8  h-full bg-transparent outline-none border-transparent ring-transparent focus:border-transparent" />
           ...
           <button 
            type="submit" 
             className={`m-0 px-4 font-bold rounded-full h-full bg-white  transition-all ease-in-out duration-200 ${description.length>1?`bg-white text-gray-600 `:`bg-white/20 text-white/50`}`}>Agregar</button>
        </div>
